...
def main():
    ...
    print("-------------------------------------------------------------------------------------------------------") 
    print (f"The highest amount earned per day was ${max(DailyEarn):.2f}0 dollars on day {max_day}.") #prints highest stored value, and the day associated with it
    print("-------------------------------------------------------------------------------------------------------") 
    
    print (f"All together, you earned ${sum(DailyEarn)}0 dollars,") #adds all listed values together and prints them
    print(f"With an average of ${(sum(DailyEarn))/5:.2f}0 dollars earned per day.") #adds all listed values together and divides them by the amount of days (5)
    print("-------------------------------------------------------------------------------------------------------") 
